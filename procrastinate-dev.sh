...
tmux send-keys -t procrastinate:test 'cd ~/src/procrastinate && PGHOST=localhost PGUSER=postgres PGDATABASE=procrastinate vex procrastinate' C-m

tmux new-window -n psql
tmux send-keys -t procrastinate:psql 'cd ~/src/procrastinate && sleep 3 && PGHOST=localhost PGUSER=postgres PGDATABASE=procrastinate psql' C-m
