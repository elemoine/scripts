...
tmux send-keys -t procrastinate:test 'cd ~/src/procrastinate && PGHOST=127.0.0.1 PGUSER=postgres PGPASSWORD=password PGDATABASE=procrastinate vex procrastinate' C-m

tmux new-window -n psql
tmux send-keys -t procrastinate:psql 'cd ~/src/procrastinate && sleep 3 && PGHOST=127.0.0.1 PGUSER=postgres PGPASSWORD=password PGDATABASE=procrastinate psql' C-m
